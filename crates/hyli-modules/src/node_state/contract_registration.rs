...
mod test {
    ...
    fn test_validate_contract_registration_hyli_tld() {
        assert!(validate_contract_name_tld(&"hyli".into(), &"newtld".into()).is_ok());
        assert!(validate_contract_name_tld(&"hyli".into(), &"".into()).is_err());
        assert!(validate_contract_name_tld(&"hyli".into(), &".".into()).is_err());
        assert!(validate_contract_name_tld(&"hyli".into(), &"hyli".into()).is_ok());
    }
