...
INSERT INTO contracts (tx_hash, parent_dp_hash, state_commitment, contract_name)
VALUES
    ('test_tx_hash_1aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'dp_hashaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', convert_to('state_commitment_1', 'UTF-8'), 'contract_1');  -- Contract 1

-- Inserting test data for the contracts verifiers table
INSERT INTO contract_verifiers (contract_name, verifier, program_id)
VALUES
    ('contract_1', 'verifier_1', convert_to('program_id_1', 'UTF-8'));
